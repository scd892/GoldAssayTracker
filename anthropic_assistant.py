...
def analyze_with_anthropic(prompt, system_prompt="", max_tokens=800):
    """
    Use Anthropic Claude to analyze data based on a prompt
...
"""
        ...
        # Call Claude API
        analysis = analyze_with_anthropic(prompt, system_prompt, max_tokens=300)
        return analysis
...
"""
        ...
        # Call Claude API
        recommendations = analyze_with_anthropic(prompt, system_prompt, max_tokens=500)
